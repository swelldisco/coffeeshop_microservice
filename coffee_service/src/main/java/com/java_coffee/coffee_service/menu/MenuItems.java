...
public class MenuItems {
    ...
    public void loadMenuItems() {
        ...
        final List<Coffee> tempList = Arrays.asList(
            new Coffee("Mocha", 3.29, ing2),
            new Coffee("Skim Latte", 3.25, ing1),
            new Coffee("Latte", 3.25, ing3),
            new Coffee("Macchiato", 3.95, ing4),
            new Coffee("Cappuccino", 3.00, ing4),
            new Coffee("Americano", 2.50, ing5),
            new Coffee("Flat White", 2.95, ing3),
            new Coffee("Red Eye", 4.50, ing5),
            new Coffee("Espresso", 2.00, ing5)
        );
